...
import img from '../../../assets/cash.webp'
            ...
            <div className="news-wrapper">
                <div className="user-list-main">
                    <div style={{ display: "flex", flexDirection: "column", marginBottom: "20px" }}>
                        <h1 className="fw-bold">My Commission</h1>
                        ...
                        <div className="viewuserlist-cards" style={{marginTop:'20px'}}>
                            <div className="viewuser-dashboard-cards-wrapper">
                                <IBdashboardcards title="0:000" data="0:000" value={"Total Comission"} />
                            </div>
